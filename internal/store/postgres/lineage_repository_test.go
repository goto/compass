...
func (r *LineageRepositoryTestSuite) TestGetColumnGraph() {
	...
	r.Run("should recursively fetch all graph", func() {
		expected := asset.LineageGraph{
			{Source: "table-30", SourceColumn: "column-2", Target: rootNode, TargetColumn: "column-final", Prop: prop},
			{Source: "table-51", SourceColumn: "column-1", Target: "table-30", TargetColumn: "column-2", Prop: prop},
			{Source: "table-50", SourceColumn: "column-3", Target: "table-30", TargetColumn: "column-2", Prop: prop},
			{Source: rootNode, SourceColumn: "column-final", Target: "table-10", TargetColumn: "column-5", Prop: prop},
			{Source: "table-10", SourceColumn: "column-5", Target: "table-22", TargetColumn: "column-4", Prop: prop},
			{Source: "table-10", SourceColumn: "column-5", Target: "table-20", TargetColumn: "column-5", Prop: prop},
		}
