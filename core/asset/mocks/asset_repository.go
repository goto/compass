...
// GetCountByIsDeletedAndServicesAndUpdatedAt provides a mock function with given fields: ctx, isDeleted, services, thresholdTime
func (_m *AssetRepository) GetCountByIsDeletedAndServicesAndUpdatedAt(ctx context.Context, isDeleted bool, services []string, thresholdTime time.Time) (uint32, error) {
	ret := _m.Called(ctx, isDeleted, services, thresholdTime)

	if len(ret) == 0 {
		panic("no return value specified for GetCountByIsDeletedAndServicesAndUpdatedAt")
	}

	var r0 uint32
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, bool, []string, time.Time) (uint32, error)); ok {
		return rf(ctx, isDeleted, services, thresholdTime)
	}
	if rf, ok := ret.Get(0).(func(context.Context, bool, []string, time.Time) uint32); ok {
		r0 = rf(ctx, isDeleted, services, thresholdTime)
	} else {
		r0 = ret.Get(0).(uint32)
	}
...
// AssetRepository_GetCountByIsDeletedAndServicesAndUpdatedAt_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetCountByIsDeletedAndServicesAndUpdatedAt'
type AssetRepository_GetCountByIsDeletedAndServicesAndUpdatedAt_Call struct {
	*mock.Call
}

// GetCountByIsDeletedAndServicesAndUpdatedAt is a helper method to define mock.On call
//   - ctx context.Context
//   - isDeleted bool
//   - services []string
//   - thresholdTime time.Time
func (_e *AssetRepository_Expecter) GetCountByIsDeletedAndServicesAndUpdatedAt(ctx interface{}, isDeleted interface{}, services interface{}, thresholdTime interface{}) *AssetRepository_GetCountByIsDeletedAndServicesAndUpdatedAt_Call {
	return &AssetRepository_GetCountByIsDeletedAndServicesAndUpdatedAt_Call{Call: _e.mock.On("GetCountByIsDeletedAndServicesAndUpdatedAt", ctx, isDeleted, services, thresholdTime)}
}

func (_c *AssetRepository_GetCountByIsDeletedAndServicesAndUpdatedAt_Call) Run(run func(ctx context.Context, isDeleted bool, services []string, thresholdTime time.Time)) *AssetRepository_GetCountByIsDeletedAndServicesAndUpdatedAt_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(bool), args[2].([]string), args[3].(time.Time))
	})
	return _c
...
func (_c *AssetRepository_GetCountByIsDeletedAndServicesAndUpdatedAt_Call) Return(_a0 uint32, _a1 error) *AssetRepository_GetCountByIsDeletedAndServicesAndUpdatedAt_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *AssetRepository_GetCountByIsDeletedAndServicesAndUpdatedAt_Call) RunAndReturn(run func(context.Context, bool, []string, time.Time) (uint32, error)) *AssetRepository_GetCountByIsDeletedAndServicesAndUpdatedAt_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetVersionHistory provides a mock function with given fields: ctx, flt, id, excludedChangelogPaths
func (_m *AssetRepository) GetVersionHistory(ctx context.Context, flt asset.Filter, id string, excludedChangelogPaths []string) ([]asset.Asset, error) {
	ret := _m.Called(ctx, flt, id, excludedChangelogPaths)
	...
	var r0 []asset.Asset
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, asset.Filter, string, []string) ([]asset.Asset, error)); ok {
		return rf(ctx, flt, id, excludedChangelogPaths)
	}
	if rf, ok := ret.Get(0).(func(context.Context, asset.Filter, string, []string) []asset.Asset); ok {
		r0 = rf(ctx, flt, id, excludedChangelogPaths)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]asset.Asset)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, asset.Filter, string, []string) error); ok {
		r1 = rf(ctx, flt, id, excludedChangelogPaths)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *AssetRepository_Expecter) GetVersionHistory(ctx interface{}, flt interface{}, id interface{}, excludedChangelogPaths interface{}) *AssetRepository_GetVersionHistory_Call {
	return &AssetRepository_GetVersionHistory_Call{Call: _e.mock.On("GetVersionHistory", ctx, flt, id, excludedChangelogPaths)}
}

func (_c *AssetRepository_GetVersionHistory_Call) Run(run func(ctx context.Context, flt asset.Filter, id string, excludedChangelogPaths []string)) *AssetRepository_GetVersionHistory_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(asset.Filter), args[2].(string), args[3].([]string))
	})
	return _c
}
...
func (_c *AssetRepository_GetVersionHistory_Call) RunAndReturn(run func(context.Context, asset.Filter, string, []string) ([]asset.Asset, error)) *AssetRepository_GetVersionHistory_Call {
	_c.Call.Return(run)
	return _c
}
...
// Upsert provides a mock function with given fields: ctx, ast, isUpdateOnly, assetConfig
func (_m *AssetRepository) Upsert(ctx context.Context, ast *asset.Asset, isUpdateOnly bool, assetConfig asset.Config) (*asset.Asset, asset.ColumnLineageProducer, error) {
	ret := _m.Called(ctx, ast, isUpdateOnly, assetConfig)
	...
	var r0 *asset.Asset
	var r1 asset.ColumnLineageProducer
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, *asset.Asset, bool, asset.Config) (*asset.Asset, asset.ColumnLineageProducer, error)); ok {
		return rf(ctx, ast, isUpdateOnly, assetConfig)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *asset.Asset, bool, asset.Config) *asset.Asset); ok {
		r0 = rf(ctx, ast, isUpdateOnly, assetConfig)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*asset.Asset)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, *asset.Asset, bool, asset.Config) asset.ColumnLineageProducer); ok {
		r1 = rf(ctx, ast, isUpdateOnly, assetConfig)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(asset.ColumnLineageProducer)
		}
	}

	if rf, ok := ret.Get(2).(func(context.Context, *asset.Asset, bool, asset.Config) error); ok {
		r2 = rf(ctx, ast, isUpdateOnly, assetConfig)
	} else {
		r2 = ret.Error(2)
	}
...
func (_e *AssetRepository_Expecter) Upsert(ctx interface{}, ast interface{}, isUpdateOnly interface{}, assetConfig interface{}) *AssetRepository_Upsert_Call {
	return &AssetRepository_Upsert_Call{Call: _e.mock.On("Upsert", ctx, ast, isUpdateOnly, assetConfig)}
}

func (_c *AssetRepository_Upsert_Call) Run(run func(ctx context.Context, ast *asset.Asset, isUpdateOnly bool, assetConfig asset.Config)) *AssetRepository_Upsert_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*asset.Asset), args[2].(bool), args[3].(asset.Config))
	})
	return _c
}

func (_c *AssetRepository_Upsert_Call) Return(_a0 *asset.Asset, _a1 asset.ColumnLineageProducer, _a2 error) *AssetRepository_Upsert_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *AssetRepository_Upsert_Call) RunAndReturn(run func(context.Context, *asset.Asset, bool, asset.Config) (*asset.Asset, asset.ColumnLineageProducer, error)) *AssetRepository_Upsert_Call {
	_c.Call.Return(run)
	return _c
}

// UpsertPatch provides a mock function with given fields: ctx, ast, patchData, isUpdateOnly, assetConfig
func (_m *AssetRepository) UpsertPatch(ctx context.Context, ast *asset.Asset, patchData map[string]interface{}, isUpdateOnly bool, assetConfig asset.Config) (*asset.Asset, asset.ColumnLineageProducer, error) {
	ret := _m.Called(ctx, ast, patchData, isUpdateOnly, assetConfig)
	...
	var r1 asset.ColumnLineageProducer
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, *asset.Asset, map[string]interface{}, bool, asset.Config) (*asset.Asset, asset.ColumnLineageProducer, error)); ok {
		return rf(ctx, ast, patchData, isUpdateOnly, assetConfig)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *asset.Asset, map[string]interface{}, bool, asset.Config) *asset.Asset); ok {
		r0 = rf(ctx, ast, patchData, isUpdateOnly, assetConfig)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*asset.Asset)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, *asset.Asset, map[string]interface{}, bool, asset.Config) asset.ColumnLineageProducer); ok {
		r1 = rf(ctx, ast, patchData, isUpdateOnly, assetConfig)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(asset.ColumnLineageProducer)
		}
	...
	if rf, ok := ret.Get(2).(func(context.Context, *asset.Asset, map[string]interface{}, bool, asset.Config) error); ok {
		r2 = rf(ctx, ast, patchData, isUpdateOnly, assetConfig)
	} else {
		r2 = ret.Error(2)
	}
...
//   - isUpdateOnly bool
//   - assetConfig asset.Config
func (_e *AssetRepository_Expecter) UpsertPatch(ctx interface{}, ast interface{}, patchData interface{}, isUpdateOnly interface{}, assetConfig interface{}) *AssetRepository_UpsertPatch_Call {
	return &AssetRepository_UpsertPatch_Call{Call: _e.mock.On("UpsertPatch", ctx, ast, patchData, isUpdateOnly, assetConfig)}
}

func (_c *AssetRepository_UpsertPatch_Call) Run(run func(ctx context.Context, ast *asset.Asset, patchData map[string]interface{}, isUpdateOnly bool, assetConfig asset.Config)) *AssetRepository_UpsertPatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*asset.Asset), args[2].(map[string]interface{}), args[3].(bool), args[4].(asset.Config))
	})
	return _c
}

func (_c *AssetRepository_UpsertPatch_Call) Return(_a0 *asset.Asset, _a1 asset.ColumnLineageProducer, _a2 error) *AssetRepository_UpsertPatch_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *AssetRepository_UpsertPatch_Call) RunAndReturn(run func(context.Context, *asset.Asset, map[string]interface{}, bool, asset.Config) (*asset.Asset, asset.ColumnLineageProducer, error)) *AssetRepository_UpsertPatch_Call {
	_c.Call.Return(run)
	return _c
}
