...
func (_m *AssetRepository) GetCountByQueryExpr(ctx context.Context, queryExpr queryexpr.ExprStr) (int, error) {
	ret := _m.Called(ctx, queryExpr)
	...
	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, queryexpr.ExprStr) (int, error)); ok {
		return rf(ctx, queryExpr)
	}
	if rf, ok := ret.Get(0).(func(context.Context, queryexpr.ExprStr) int); ok {
		r0 = rf(ctx, queryExpr)
	} else {
		r0 = ret.Get(0).(int)
	}
...
func (_c *AssetRepository_GetCountByQueryExpr_Call) RunAndReturn(run func(context.Context, queryexpr.ExprStr) (int, error)) *AssetRepository_GetCountByQueryExpr_Call {
	_c.Call.Return(run)
	return _c
}
