...
// Group provides a mock function with given fields: ctx, cfg
func (_m *DiscoveryRepository) Group(ctx context.Context, cfg asset.GroupConfig) ([]asset.GroupResult, error) {
...
// DiscoveryRepository_Group_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Group'
type DiscoveryRepository_Group_Call struct {
	*mock.Call
}
...
func (_e *DiscoveryRepository_Expecter) Group(ctx interface{}, cfg interface{}) *DiscoveryRepository_Group_Call {
	return &DiscoveryRepository_Group_Call{Call: _e.mock.On("Group", ctx, cfg)}
}

func (_c *DiscoveryRepository_Group_Call) Run(run func(ctx context.Context, cfg asset.GroupConfig)) *DiscoveryRepository_Group_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *DiscoveryRepository_Group_Call) Return(results []asset.GroupResult, err error) *DiscoveryRepository_Group_Call {
	_c.Call.Return(results, err)
	return _c
}

func (_c *DiscoveryRepository_Group_Call) RunAndReturn(run func(context.Context, asset.GroupConfig) ([]asset.GroupResult, error)) *DiscoveryRepository_Group_Call {
	_c.Call.Return(run)
	return _c
}
